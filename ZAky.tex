...
\textbf{\textsc{Email:}}   \href{mailto:zaky.fetoh@gmail.com}{zaky.fetoh@gmail.com} && \textbf{\textsc{Phone:}} +201022381474 \\
...
\begin{tabular}{rl}	
    ...
    \textbf{DevOps}:& Docker, Docker-Compose, Kubernetes(learning).\\
    \textbf{Message Broker}:& RabbitMQ, Kafka(learning).\\
    \textbf{Caching}:& Redis, MinIO(learning).\\
    \textbf{Testing}:& Jest.\\ 
\end{tabular}
%%END TABLE
