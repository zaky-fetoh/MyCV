...
% \begin{small}
    ...
    \begin{longtable}{r p{16cm}}
        ...
        \begin{itemize}
        \textit{tools used: } DMS, DataSync, S3, RDS, ECS, Glue Job, Glue Crawler, Firehose.
    \end{itemize}\\
        &\\ 
        2024  & \textbf{Centeralizing Terraform Execution}, [Bexprt's Customer].\\&
        Migrating the terraform to the terraform cloud. \begin{itemize}
        \textit{tools used: } Terraform, terraform-cloud.
\end{itemize}\\
        &\\ 
        ...
        \begin{itemize}
        \textit{tools used: } Terraform, S3, Cloudfront, cert-manger, Route53.
    \end{itemize}\\
        &\\ 
