...
\begin{tabular}{r|l}
    ...
    \textbf{ML Model Deployment}: SageMaker, bentoml, Prefect, MLflow. \\&
...
% \begin{small}
    ...
    \begin{longtable}{r p{16cm}}
        ...
        \begin{itemize}
            \item \textit{tools used: } Terraform, Github actions.
        \end{itemize}\\
        ...
        producing Terraform code and Migrating all datalake related services to new AWS account and providing cross account access to ETL pipelines.
        \begin{itemize}
            \item \textit{tools used: } Terraform, DMS, DataSync, S3, RDS, ECS, Glue Job, Glue Crawler, Firehose, IAM.
        \end{itemize}\\
