...
\begin{tabular}{r|l}
    2023-Present & \textbf{Data Scientist } \\&
    \textbf{Susoft}, Norway \\& 
    Building microservice application for Training and deploying machine and deep learning models \\&  for Sales forecasting using. 
    ...
    \textbf{Gateway} and load balancing services done using NodeJS.
\\
\end{tabular}
