...
\begin{tabular}{r|l}
    ...
    \textit{-Technologies}:\\&
    \textbf{Clould Provider}: AWS, OCI. \\&
    \textbf{Kubernetes}: EKS, OKE. \\&
    ...
    \textbf{DNS and firewall}: Cloudflare.\\&
...
\begin{tabular}{rl}	
    ...
    & Jenkins, Terraform, Ansible, cloudflare, ArgoCD, Istio. \\
...
%         2022  & \textbf{Multiscale aware classification of COVID-19 from Chest X-Ray using a spatially weighted atrous spatial pyramid pooling CNN}.\\& \textbf{Mahmoud Z fetoh}, Khalid M. Amin, Ahmed M. Hamad \\&
...
% \begin{small}
    ...
    \begin{longtable}{r p{16cm}}
        ...
        \begin{itemize}
            ...
            \item Exposing REST api allows the DevTeam to modify env vars.
        ...
        \end{itemize}
        \textit{tools used: } Kustomize, Jenkins, argoCD, Python, NodeJS, bashScript, Reloader, Helm.\\
        &\\ 
